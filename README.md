...
- 目前最新版：**v1.2.10**（2026-09-10）
- 下載頁：[Releases / 最新版](https://github.com/power79461382-hash/Minecraft-Modpack-Translator/releases/latest)
- 直接下載：[MinecraftTranslatorGUI.exe（v1.2.6）](https://github.com/power79461382-hash/Minecraft-Modpack-Translator/releases/download/v1.2.10/MinecraftTranslatorGUI.exe)
...
### 2026-09-10 v1.2.10 DeepSeek truncation auto-split
...
### 2026-09-10 v1.2.10 Restore GTX high throughput
